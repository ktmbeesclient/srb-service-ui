...
export default function Home() {
  ...
  useEffect(() => {
    const role = getCookie("client_role");

    if (role === UserRolesEnum.SUPER_ADMIN) {
      router.replace("/admin/clients");
    } else if (role === UserRolesEnum.CLIENT) {
  ...
  return (
    ...
    >
      ...
      <main className="mx-auto flex max-w-300 flex-2 flex-col items-center justify-center px-6 text-center py-12 sm:px-12">
        ...
        <p className="mx-auto mb-8 max-w-[520px] text-[16.5px] leading-[1.65] text-[#40493f]">
      ...
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="border-t border-[#d8d3c0]/60 pt-4 text-center text-[11px] text-[#7a7a68]">
            ...
            <span className="font-semibold text-[#1e2a22]">SRB Services</span>.
            All rights reserved.
          </div>
        </div>
      </footer>
